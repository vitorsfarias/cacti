...
if (sizeof($parms)) {
	...
	if (sizeof($data_queries)) {
		...
		echo "WARNING: Do not interrupt this script.  Reindexing can take quite some time" . "\n";
...
function display_help($me) {
	echo "Reorder Data Query Script 1.0" . ", " . "Copyright 2004-2012 - The Cacti Group" . "\n";
	echo "A simple command line utility to reorder data queries in Cacti" . "\n\n";
	...
	echo "   " . "  performs reordering of data query id 3 on device id 5 to current <index_order>" . "\n";
	echo "   php -q " . $me . "  --data-query-id=3 --template=8\n";
	echo "   " . "  same as above, working on all devices associated with template id of 8" . "\n";
}
