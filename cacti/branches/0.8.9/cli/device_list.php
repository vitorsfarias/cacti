...
if (sizeof($parms)) {
	...
	displayHosts($devices, $quietMode);
...
function display_help($me) {
	echo "Device List Script 1.1" . ", " . "Copyright 2004-2011 - The Cacti Group" . "\n";
	...
	echo "   --list-communities          " . "list all community strings used" . "\n";
	...
	echo "   " . "  lists all devices related to a device template id of 1" . "\n";
	echo "   php -q " . $me . " --port=161 --timeout=500\n";
	echo "   " . "  lists all devices using SNMP port of 161 and timeout of 500" . "\n";
}
