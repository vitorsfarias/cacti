...
if (sizeof($parms)) {
	 ...
	 */
	$device_name = db_fetch_cell("SELECT hostname FROM host WHERE id = " . $host_id);
...
function display_help($me) {
	echo "Add Graph Template Script 1.0" . ", " . __("Copyright 2004-2014 - The Cacti Group") . "\n";
