	...
	if (isset($type)) {
		switch (strtolower($type)) {
			...
			case (strtolower($tree_types[TREE_TYPE_NODE])):
				...
				if (!isset($tree_item["host_grouping_type"])) 	$tree_item["host_grouping_type"] 	= TREE_DEVICE_GROUPING_GRAPH_TEMPLATE;
...
function display_help($me) {
	echo "Create Tree Script 1.0" . ", " . __("Copyright 2004-2012 - The Cacti Group") . "\n";
