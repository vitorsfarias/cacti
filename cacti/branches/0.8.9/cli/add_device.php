...
include_once(CACTI_LIBRARY_PATH . "/api_data_source.php");
...
include_once(CACTI_LIBRARY_PATH . "/api_device.php");
...
function display_help() {
	echo "Add Device Script 1.0, Copyright 2004-2012 - The Cacti Group\n\n";
