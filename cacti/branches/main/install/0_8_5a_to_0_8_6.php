...
function upgrade_to_0_8_6() {
	include(CACTI_LIBRARY_PATH . "/data_query.php");
	include(CACTI_LIBRARY_PATH . "/tree.php");
	include(CACTI_LIBRARY_PATH . "/import.php");
	include(CACTI_LIBRARY_PATH . "/poller.php");
