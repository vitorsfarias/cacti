...
$graph_timeshifts = array(
	GTS_HALF_HOUR 	=> array("native" => "30 Min", "localized" => __("30 Min")),
	GTS_1_HOUR 		=> array("native" => "1 Hour", "localized" => __("1 Hour")),
	GTS_2_HOURS 	=> array("native" => "2 Hours", "localized" => __("%d Hours", 2)),
	GTS_4_HOURS 	=> array("native" => "4 Hours", "localized" => __("%d Hours", 4)),
	GTS_6_HOURS 	=> array("native" => "6 Hours", "localized" => __("%d Hours", 6)),
	GTS_12_HOURS 	=> array("native" => "12 Hours", "localized" => __("%d Hours", 12)),
	GTS_1_DAY 		=> array("native" => "1 Day", "localized" => __("1 Day")),
	GTS_2_DAYS 		=> array("native" => "2 Days", "localized" => __("%d Days", 2)),
	GTS_3_DAYS 		=> array("native" => "3 Days", "localized" => __("%d Days", 3)),
	GTS_4_DAYS 		=> array("native" => "4 Days", "localized" => __("%d Days", 4)),
	GTS_1_WEEK 		=> array("native" => "1 Week", "localized" => __("1 Week")),
	GTS_2_WEEKS 	=> array("native" => "2 Weeks", "localized" => __("%d Weeks", 2)),
	GTS_1_MONTH 	=> array("native" => "1 Month", "localized" => __("1 Month")),
	GTS_2_MONTHS 	=> array("native" => "2 Months", "localized" => __("%d Months", 2)),
	GTS_3_MONTHS 	=> array("native" => "3 Months", "localized" => __("%d Months", 3)),
	GTS_4_MONTHS 	=> array("native" => "4 Months", "localized" => __("%d Months", 4)),
	GTS_6_MONTHS 	=> array("native" => "6 Months", "localized" => __("%d Months", 6)),
	GTS_1_YEAR 		=> array("native" => "1 Year", "localized" => __("1 Year")),
	GTS_2_YEARS 	=> array("native" => "2 Years", "localized" => __("%d Years", 2))
	);
