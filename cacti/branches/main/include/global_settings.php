...
$tabs_graphs = array(
	...
	$mail_javascript = '<script type="text/javascript">
<!--
   function emailtest() {
      w = 450;
      h = 450;
      email = window.open("settings.php?action=emailtest", "EmailTest", "width=" + w + ",height=" + h + ",resizable=1,status=0");
...
$settings = array(
	...
	"legend" => array(
		...
		"cl2_hard_return" => array(
			"friendly_name" => __("Insert Hard Return"),
			"method" => "checkbox",
			"default" => "",
			"description" => __("Forces the legend to the next line after this item."),
			),
		"custom_legend_header3" => array(
		...
		"cl3_hard_return" => array(
			"friendly_name" => __("Insert Hard Return"),
			"method" => "checkbox",
			"default" => CHECKED,
			"description" => __("Forces the legend to the next line after this item."),
			),
		"custom_legend_header4" => array(
	...
	"poller" => array(
		...
		"max_get_size" => array(
			...
			"description" => __("The maximum number of snmp get OID's to issue per snmpbulkwalk request.  Increasing this value speeds poller performance over slow links.  The maximum value is 100 OID's.  Decreasing this value to 0 or 1 will disable snmpbulkwalk"),
			"method" => "textbox",
			"default" => "10",
			"max_length" => "10",
			"size" => "5"
	...
	"logging" => array(
		...
		"log_destination" => array(
			...
			"items" => array(
				"log_dest_cacti" => array(
					"friendly_name" => __("Cacti System Log"),
					"default" => "on"
				),
				"log_dest_system" => array(
					"friendly_name" => __("Localhost System Log"),
					"default" => ""
					),
				"log_dest_syslog" => array(
					"friendly_name" => __("Syslog Server"),
					"default" => ""
					)
				)
			),
		"log_severity" => array(
			"friendly_name" => __("Severity Logging Level"),
			"description" => __("Level of detail to send to log.  When selecting a severity level, every level above that will be logged as well."),
			"method" => "drop_array",
			"default" => CACTI_LOG_SEV_NOTICE,
			"array" => $log_level
			),
		"log_control_header" => array(
			"friendly_name" => __("Cacti System Log Size and Control"),
			"method" => "spacer"
			),
		"log_size" => array(
			"friendly_name" => __("Maximum Log Size"),
			"description" => __("The maximum number of records to store in the Cacti log.  The log will be pruned after each polling cycle.  The maximum number of records is an approximate value due to the nature of the record count check."),
			"default" => "1000000",
			"method" => "textbox",
			"max_length" => "10"
			),
		"log_control" => array(
			"friendly_name" => __("Log Control Mechanism"),
			"description" => __("How Cacti controls the log size.  The default is to overwrite as needed."),
			"method" => "drop_array",
			"default" => 1,
			"array" => $log_control_options
			),
		"log_maxdays" => array(
			"friendly_name" => __("Maximum Retention Period"),
			"description" => __("All events older than the specified number of days will be discarded if the maximum number of recrods in the Cacti System Log is reached."),
			"method" => "textbox",
			"default" => "7",
			"max_length" => "3"
			),
		"log_system_header" => array(
			"friendly_name" => __("System Log Settings"),
			"method" => "spacer"
			),
		"log_system_facility" => array(
			"friendly_name" => __("System Syslog Facility"),
			"description" => __("Facility to utilize when using syslog. For Windows enviroments set to USER."),
			"method" => "drop_array",
			"default" => LOG_USER,
			"array" => $log_system_facility
			),
		"log_syslog_header" => array(
			"friendly_name" => __("Syslog Server Settings"),
			"method" => "spacer"
			),
		"log_syslog_server" => array(
			"friendly_name" => __("Syslog Server"),
			"description" => __("Syslog Server to send syslog message to. To use TCP port, proceed server with \"tcp://\"."),
			"method" => "textbox",
			"default" => "localhost",
			"max_length" => "255"
			),
		"log_syslog_port" => array(
			"friendly_name" => __("Syslog Server Port"),
			"description" => __("Syslog Server port to send syslog message to."),
			"method" => "textbox",
			"default" => "514",
			"max_length" => "5"
			),
		...
		"log_email_header" => array(
			"friendly_name" => __("Event Log Emailing"),
			"method" => "spacer"
			),
		"log_email_level" => array(
			"friendly_name" => __("Log Email Level"),
			"description" => __("Level of detail to send in email.  When selecting a severity level, every level above that will be logged as well."),
			"method" => "drop_array",
			"default" => CACTI_LOG_SEV_CRITICAL,
			"array" => $log_level
			),
		"log_email_group" => array(
			"friendly_name" => __("Email Group"),
			"description" => __("Events will be emailed in batches to the assigned user group."),
			"method" => "drop_array",
			"default" => "",
			"array" => array()
			)
	...
	"mail" => array(
		"settings_email_header" => array(
			...
			__("Emailing Options") . "</td><td align=right class='textSubHeaderDark'><a href='javascript:emailtest();' class='textSubHeaderDark'>" .
			"<font color=white>" . __("Send a Test Email") . "</font></a></td></tr></table>",
			"method" => "spacer",
			),
		"settings_test_email" => array(
			"friendly_name" => __("Test Email Target Receiver"),
		...
		"settings_smtp_host" => array(
			...
			"description" => __("This is the hostname/IP of the SMTP Server you will send the email to."),
			"method" => "textbox",
			"default" => "localhost",
			"max_length" => 255,
			),
		"settings_smtp_port" => array(
			...
			"description" => __("This is the port on the SMTP Server that SMTP uses."),
			"method" => "textbox",
			"max_length" => 255,
			"default" => 25,
			),
		"settings_smtp_username" => array(
			...
			"description" => __("This is the username to authenticate with when sending via SMTP. (Leave blank if you do not require authentication.)"),
			"method" => "textbox",
			"max_length" => 255,
			),
		"settings_smtp_password" => array(
			"friendly_name" => __("SMTP Password"),
			"description" => __("This is the password to authenticate with when sending via SMTP. (Leave blank if you do not require authentication.)"),
			"method" => "textbox_password",
			"max_length" => 255,
			),
