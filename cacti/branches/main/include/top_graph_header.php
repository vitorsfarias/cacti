...
<head>
	...
	elseif (isset($_SESSION['action']) && $_SESSION['action'] == 'zoom')
	{
		print "<meta http-equiv=refresh content='99999'>\r\n";
	}
	else
...
<div id='header'>
	...
	<div id='navbar'>
		...
		<div id='navbar_r'>
			<ul>
				...
				{
					echo '			' . draw_header_tab('graph_settings', __('Settings'), CACTI_URL_PATH . 'graph_settings.php');
					echo '			' . draw_header_tab('tree', __('Tree'), CACTI_URL_PATH . 'graph_view.php?action=tree', CACTI_URL_PATH . 'images/tab_mode_tree_new.gif');
					echo '			' . draw_header_tab('list', __('List'), CACTI_URL_PATH . 'graph_view.php?action=list', CACTI_URL_PATH . 'images/tab_mode_list_new.gif');
					echo '			' . draw_header_tab('preview', __('Preview'), CACTI_URL_PATH . 'graph_view.php?action=preview', CACTI_URL_PATH . 'images/tab_mode_preview_new.gif');
				}
				else
				{
					plugin_hook('top_graph_header_tabs_right');
				}
				?>
			</ul>
		</div>
	...
	<div id='navbrcrumb'>
		...
		<div style='float:right;'>
			<span id='menu_languages' class='cacti_dd_link'><img src='<?php echo CACTI_URL_PATH; ?>images/icons/flags/<?php print CACTI_COUNTRY; ?>.gif' alt='<?php print CACTI_COUNTRY;i ?>' align='top'>&nbsp;<?php print $lang2locale[CACTI_LOCALE]['language']; ?></span>
		</div>
