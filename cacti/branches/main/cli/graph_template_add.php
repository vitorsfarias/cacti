...
if (sizeof($parms)) {
	...
	if ((isset($exists_already)) &&
		...
		plugin_hook_function('add_graph_template_to_device', array("device_id" => $device_id, "graph_template_id" => $graph_template_id));
	}
...
function display_help($me) {
	echo "Add Graph Template Script 1.0" . ", " . __("Copyright 2004-2011 - The Cacti Group") . "\n";
