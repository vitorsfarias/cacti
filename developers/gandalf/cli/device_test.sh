...
# assume template "Localhost" is assigned
php -q device_list.php --template=8
php -q device_list.php --port=161 --timeout=500

clear
echo -----------------------
echo add and remove devices, assume, a site=1 and a poller= 1 exist
echo -----------------------
php -q device_create.php --help
php -q device_create.php --ip=example1.company.com --description=foobar --template=1
php -q device_create.php --ip=example2.company.com --description=foobar --template=1 --community=secret --avail=snmp --version=1
#php -q device_create.php --ip=example3.company.com --description=foobar --template=1 --site-id=1 --poller-id=1
