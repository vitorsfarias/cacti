...
<head>
	...
	<script type="text/javascript" src="<?php echo $config['url_path']; ?>include/jquery.js"></script>
	<script type="text/javascript" src="<?php echo $config['url_path']; ?>include/jquery.zoom.js"></script>
</head>
